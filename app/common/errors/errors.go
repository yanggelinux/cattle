...
func ParseWithCoder(err error) (*withCode, bool) {
	if err == nil {
		return nil, false
	}
...
func WithCodeError(code int, err error) error {
...
func WithCodeMessage(code int, message string) error {
...
func WithCode(code int, message string, err error) error {
